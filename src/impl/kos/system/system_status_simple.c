...
// =============================================================================
// KOS - Simple System Status Display Implementation
// =============================================================================
...
// =============================================================================
// System Status API Implementation (Simplified)
// =============================================================================
...
hal_result_t kos_system_status_show_component(const char* component, kos_status_level_t level, const char* status) {
    ...
    kos_vga_color_t fg_colors[] = {
        ...
        KOS_VGA_COLOR_LIGHT_GREEN,   // SUCCESS
        KOS_VGA_COLOR_LIGHT_YELLOW,  // WARNING
        KOS_VGA_COLOR_LIGHT_RED,     // ERROR
...
hal_result_t kos_system_status_show_memory_info(void) {
    ...
    vga_set_color(KOS_VGA_COLOR_LIGHT_YELLOW, KOS_VGA_COLOR_BLACK);
...
void kos_status_print_box(const char* title, const char* content) {
    vga_set_color(KOS_VGA_COLOR_LIGHT_WHITE, KOS_VGA_COLOR_BLACK);
    vga_write_string("┌─ ");
